...
const SCRIPT_NAMEJ = "FUSIONインポートメイン";

import { execSync } from 'child_process';
import { DATA_LOG_DIR, IMPORT_FUSION_TUWA, IMPORT_FUSION_BILL } from '../../db_define/define';
...
(() => {
	...
	var cmd = (PHP + " " + IMPORT_FUSION_BILL + co_arg);
	// system(cmd, status);
	...
	cmd = (PHP + " " + IMPORT_FUSION_TUWA + co_arg2);
	// // system(cmd, status);
