...
import { G_CARRIER_DOCOMO, G_CIRCUIT_DOCOMO_XI, G_CIRCUIT_FOMA, G_CIRCUIT_MOVA, G_DOCOMO_SIM_DAYTIME_RATIO } from "./script_common";
...
export const PACKETID_DISRATIO_PACT_FOMA = "3002,3003,3004,3014";
