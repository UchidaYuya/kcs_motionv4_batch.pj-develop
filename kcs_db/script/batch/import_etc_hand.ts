...
(() => {
	const DEBUG_FLG = 1;
	const SCRIPT_ETC_HAND_BILL = BAT_DIR + "/import_etc_handbill.php";
	const SCRIPT_ETC_HAND_HIST = BAT_DIR + "/import_etc_handhist.php";
	...
	var command_str = "php " + SCRIPT_ETC_HAND_BILL + " -e=" + mode + " -y=" + billdate + " -p=" + pactid + " -b=" + backup + " -t=" + target;
	// print("ETC\u624B\u5165\u529B\u8ACB\u6C42\u30C7\u30FC\u30BF\u53D6\u8FBC\u51E6\u7406\u3092\u958B\u59CB\u3057\u307E\u3059" + command_str + "\n");
	// system(command_str, ret);

	try{
		console.log("ETC手入力請求データ取込処理を開始します" + command_str + "\n");
		execSync(command_str);
	}catch(error:any){
		console.log("ETC手入力請求データ取込処理でエラーが発生しました。" + "\n" + "処理を中断します。" + "\n");
		process.exit(error.status);
	}

	// if (ret != 0) {
	// 	// print("ETC\u624B\u5165\u529B\u8ACB\u6C42\u30C7\u30FC\u30BF\u53D6\u8FBC\u51E6\u7406\u3067\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F\u3002" + "\n" + "\u51E6\u7406\u3092\u4E2D\u65AD\u3057\u307E\u3059\u3002" + "\n");
	// 	console.log("ETC手入力請求データ取込処理でエラーが発生しました。" + "\n" + "処理を中断します。" + "\n");
	// 	throw process.exit(1);
	// }

	command_str = "php " + SCRIPT_ETC_HAND_HIST + " -e=" + mode + " -y=" + billdate + " -p=" + pactid + " -b=" + backup + " -t=" + target;
	// print("ETC\u624B\u5165\u529B\u5229\u7528\u660E\u7D30\u30C7\u30FC\u30BF\u53D6\u8FBC\u51E6\u7406\u3092\u958B\u59CB\u3057\u307E\u3059" + command_str + "\n");
	// passthru(command_str);
	try {
		console.log("ETC手入力利用明細データ取込処理を開始します" + command_str + "\n");
		execSync(command_str);
	} catch (error) {
