...
(() => {
	const DEBUG_FLG = 0;
	const SCRIPT_ETC_CORP_BILL = BAT_DIR + "/import_etc_corpbill.php";
	const SCRIPT_ETC_CORP_HIST = BAT_DIR + "/import_etc_corphist.php";
	var A_para = 5;
	...
	// var command_str = "php " + SCRIPT_ETC_CORP_BILL + " -e=" + mode + " -y=" + billdate + " -p=" + pactid + " -b=" + backup + " -t=" + target;
	var command_str = "php " + SCRIPT_ETC_CORP_BILL + " -e=" + mode + " -y=" + billdate + " -p=" + pactid + " -b=" + backup + " -t=" + target;
	// print("ETC\u30B3\u30FC\u30DD\u30EC\u30FC\u30C8\u30AB\u30FC\u30C9\u8ACB\u6C42\u30C7\u30FC\u30BF\u53D6\u8FBC\u51E6\u7406\u3092\u958B\u59CB\u3057\u307E\u3059" + command_str + "\n");
	// system(command_str, ret);
	try{
		console.log("ETCコーポレートカード請求データ取込処理を開始します" + command_str + "\n");
		execSync(command_str);
	}catch(error:any){
		console.log("ETCコーポレートカード請求データ取込処理でエラーが発生しました。" + "\n" + "処理を中断します。" + "\n");
		throw process.exit(error.status);
	}

	// if (ret != 0) {
	// 	// print("ETC\u30B3\u30FC\u30DD\u30EC\u30FC\u30C8\u30AB\u30FC\u30C9\u8ACB\u6C42\u30C7\u30FC\u30BF\u53D6\u8FBC\u51E6\u7406\u3067\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F\u3002" + "\n" + "\u51E6\u7406\u3092\u4E2D\u65AD\u3057\u307E\u3059\u3002" + "\n");
	// 	console.log("ETCコーポレートカード請求データ取込処理でエラーが発生しました。" + "\n" + "処理を中断します。" + "\n");
	// 	throw process.exit(1);
	// }

	command_str = "php " + SCRIPT_ETC_CORP_HIST + " -e=" + mode + " -y=" + billdate + " -p=" + pactid + " -b=" + backup + " -t=" + target;
	// print("ETC\u30B3\u30FC\u30DD\u30EC\u30FC\u30C8\u30AB\u30FC\u30C9\u5229\u7528\u660E\u7D30\u30C7\u30FC\u30BF\u53D6\u8FBC\u51E6\u7406\u3092\u958B\u59CB\u3057\u307E\u3059" + command_str + "\n");
	console.log("ETCコーポレートカード利用明細データ取込処理を開始します" + command_str + "\n");
