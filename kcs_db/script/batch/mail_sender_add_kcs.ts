...
//
//作成：森原
//更新：前田　送信先にkcsmotion@kcs.ne.jpを追加出来る用改良 2013/6/5
...
import { G_MAILINGLIST_ADD_KCS, G_MAIL_FROM, G_SMTP_HOST, G_SMTP_PORT } from "../../db_define/define";
...
export default class ScriptLogMail extends ScriptLogBase {
	...
	
	{
		...
		var rval = O_mail.send(G_MAILINGLIST_ADD_KCS, H_headers, body);
