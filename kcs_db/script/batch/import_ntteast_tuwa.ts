...
export const G_PROCNAME_J_IMPORT = "通話詳細インポートプロセス[NTT東日本]]";
export const G_PROCNAME_IMPORT = "import_ntt_east";
export const G_PROCNAME = "import_ntt_east";
export const G_COMPANY_ID = "NTT_east/tuwa";
export const G_CARRIER_ID = "7";
...
//ＮＴＴ東日本custom
//一行(固定長)を分割して処理する
export default class import_ntt_east extends import_ntt_tuwa_base {
	async doDivisionLine(line: string, ins_comm: any, a_bill_prtel: string) //バグ修正 戻り値がデータにより帰らない 2004.12.07 by suehiro
	//Prime / Custom 別の処理
	//頭文字取得
	//バグ修正 戻り値がデータにより帰らない 2004.12.07 by suehiro
	{
// 2022cvt_015
		var res: boolean | Promise<boolean>;
// 2022cvt_015
...
// 				echo("\u8B66\u544A\uFF1A \u51E6\u7406\u5BFE\u8C61\u306E\u30D5\u30A1\u30A4\u30EB\u540D\u79F0(" + this.m_file_name + ")\u304C\u4E0D\u6B63\u3067\u3059\u3002M\u304BR\u3067\u59CB\u307E\u308B\u30D5\u30A1\u30A4\u30EB\u540D\u306B\u3057\u3066\u304F\u3060\u3055\u3044\u3002\n");// 2022cvt_010
	...
	async doDivisionLineForPrime(line: any, ins_comm: any, a_bill_prtel: string) //レコード種別:G_RECODE_IDのみ
	{
// 2022cvt_015
...
// 						echo("\u8B66\u544A\uFF1A\u8AB2\u91D1\u5148\u96FB\u8A71\u756A\u53F7(" + bill_telno + ")\u304C\u8907\u6570\u5B58\u5728\u3057\u307E\u3059\u3002\n");// 2022cvt_010
...
// 								echo(`警告：データの請求月が処理対象月と異なります。file:${this.m_targetFile} (` + this.m_targetLine + "\u884C\u76EE) \n");// 2022cvt_010
								global.G_COMMON_LOG.putError(G_SCRIPT_ERROR, this.m_procname_j + " " + this.m_target_pactid + " " + this.m_compname + " " + yyyymm + " " + this.m_targetFile + ` 警:データの請求月が処理対象月と異なります。file:${this.m_targetFile} (` + this.m_targetLine + "行目)", 3);
								this.m_warningCount++;
								return false;
							}
					}
...
// 				}
	...
	async doDivisionLineForCustom(line: any, ins_comm: any, a_bill_prtel: any) //レコード種別:G_RECODE_IDのみ
	{
// 2022cvt_015
        var yyyymm = this.m_year + this.m_month;
		var recode_id = line.substring(0, 1);
...
// 2022cvt_015
var proc = new import_ntt_east(G_PROCNAME_IMPORT, G_PROCNAME_J_IMPORT, G_LOG, G_OPENTIME);
