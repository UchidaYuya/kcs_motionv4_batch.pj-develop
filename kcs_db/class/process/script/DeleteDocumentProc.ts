...
import {DeleteDocumentView} from '../../view/script/DeleteDocumentView';
import {DeleteDocumentModel} from '../../model/script/DeleteDocumentModel';

export default class DeleteDocumentProc extends ProcessBaseBatch {

	O_View: DeleteDocumentView;
	O_Model: DeleteDocumentModel;
	...
	{
		super(H_param);
		this.O_View = new DeleteDocumentView();
		this.O_Model = new DeleteDocumentModel(this.get_MtScriptAmbient());
	}
