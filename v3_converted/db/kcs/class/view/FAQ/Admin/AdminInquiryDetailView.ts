...
//@return void
//
class AdminInquiryDetailView extends InquiryBaseView {
	...
	checkCGIParam() {
		...
		if (false !== this.gSess().getSelf("fnc") && undefined !== this.gSess().getSelf("fnc")) {
			this.Mode = "editfnc";
		}
		...
		if (false !== this.gSess().getSelf("status") && undefined !== this.gSess().getSelf("status")) {
			this.Mode = "statusfnc";
		}
		...
		if (false !== this.gSess().getSelf("publiclevel") && undefined !== this.gSess().getSelf("publiclevel")) {
			this.Mode = "publicfnc";
		}
