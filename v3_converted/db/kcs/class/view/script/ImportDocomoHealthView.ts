...
//@return void
//
class ImportDocomoHealthView extends ViewBaseScript {
	constructor() //親のコンストラクタを必ず呼ぶ
	{
		super();
		var A_arg_help = [["-e", "CharSwitch", "\u30E2\u30FC\u30C9\t\t\tO:delete\u5F8CCOPY,A:\u8FFD\u52A0", "O,A"], ["-y", "YYYYMM", "\u8ACB\u6C42\u5E74\u6708\t\t\tYYYY:\u5E74,MM:\u6708"], ["-p", "pactid", "\u5951\u7D04\uFF29\uFF24\t\t\tall:\u5168\u9867\u5BA2\u5206\u3092\u5B9F\u884C,PACTID:\u6307\u5B9A\u3057\u305F\u5951\u7D04\uFF29\uFF24\u306E\u307F\u5B9F\u884C"], ["-b", "CharSwitch", "\u30D0\u30C3\u30AF\u30A2\u30C3\u30D7\t\tY:\u3059\u308B,N:\u3057\u306A\u3044", "Y,N"], ["-t", "CharSwitch", "\u30D8\u30EB\u30B9\u30B1\u30A2\u7BA1\u7406\u30C6\u30FC\u30D6\u30EB\tN:healthcare_tb\u3078\u30A4\u30F3\u30B5\u30FC\u30C8,O:healthcare_X_tb\u3078\u30A4\u30F3\u30B5\u30FC\u30C8", "N,O"]];
