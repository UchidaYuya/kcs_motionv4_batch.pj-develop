...
//@return void
//
class ReflectBillingDataView extends ViewBaseScript {
	constructor() //親のコンストラクタを必ず呼ぶ
	{
		super();
		var A_arg_help = [["-y", "YYYYMM", "\u8ACB\u6C42\u5E74\u6708\t\tYYYY:\u5E74,MM:\u6708"], ["-p", "pactid", "\u5951\u7D04\uFF29\uFF24\t\tall:\u5168\u9867\u5BA2\u5206\u3092\u5B9F\u884C,PACTID:\u6307\u5B9A\u3057\u305F\u5951\u7D04\uFF29\uFF24\u306E\u307F\u5B9F\u884C"], ["-c", "carid", "\u30AD\u30E3\u30EA\u30A2\t\tall:\u5BFE\u5FDC\u5168\u30AD\u30E3\u30EA\u30A2\u3092\u5B9F\u884C,CARID:\u6307\u5B9A\u3057\u305FCARID\u306E\u307F\u5B9F\u884C"]];
