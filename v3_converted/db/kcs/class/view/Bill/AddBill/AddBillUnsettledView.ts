...
//@return void
//
class AddBillUnsettledView extends ViewSmarty {
	static PUB = "/Bill";

	constructor() {
		super();
		this.UnsettledName = "\u672A\u78BA\u5B9A\u306B\u623B\u3059";
		this.O_Sess = MtSession.singleton();
		this.H_Dir = this.O_Sess.getPub(AddBillUnsettledView.PUB);
	...
	{
		var H_sess = {
			[AddBillUnsettledView.PUB]: this.O_Sess.getPub(AddBillUnsettledView.PUB),
	...
	//セッションに記録する
	{
		...
		this.O_Sess.SetPub(AddBillUnsettledView.PUB, this.H_Dir);
	...
	//完了画面表示
	{
		...
		O_finish.displayFinish("\u53D7\u6CE8\u5185\u5BB9\u306E\u672A\u78BA\u5B9A\u3078\u306E\u5909\u66F4", menu_uri, "\u53D7\u6CE8\u5185\u5BB9\u4E00\u89A7\u753B\u9762\u3078");
	}
	...
	//$this->get_Smarty()->display($this->getDefaultTemplate());
	{
		...
		this.get_Smarty().display(KCS_DIR + "/template/Bill/AddBill/AddBillUnsettled.tpl");
	}
