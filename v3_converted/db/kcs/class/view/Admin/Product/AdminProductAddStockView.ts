...
//@return void
//
class AdminProductAddStockView extends AdminProductStockView {
	getSubmitFlag() {
	...
	constructor(H_navi) {
		...
		this.H_assign.admin_fncname = "\u5728\u5EAB\u30DE\u30B9\u30BF\u30FC\u65B0\u898F\u767B\u9332";
	...
	checkCGIParam() {
		...
		if (true == (undefined !== _POST.submit) && ("\u78BA\u8A8D\u753B\u9762\u3078" == _POST.submit || "\u767B\u9332\u3059\u308B" == _POST.submit)) {
		...
		if (false == !submit && "\u767B\u9332\u3059\u308B" === String(submit)) {
	...
	//完了画面
	{
		...
		O_finish.displayFinish("\u5728\u5EAB\u30DE\u30B9\u30BF\u30FC\u306E\u65B0\u898F\u767B\u9332", "/Admin/Product/stock_menu.php", "\u5728\u5EAB\u30DE\u30B9\u30BF\u30FC\u4E00\u89A7\u3078");
	}
