...
//@return void
//
class TransitDownloadView extends ManagementDownloadViewBase {
	constructor() {
		super();
	}
	...
	{
		this.H_View.A_head = ["\u30B7\u30B9\u30C6\u30E0\u90E8\u7F72ID", "\u90E8\u7F72ID", "\u90E8\u7F72\u540D", "\u904B\u9001ID", "\u4F1A\u793EID", "\u4F1A\u793E", "\u62C5\u5F53\u8005", "\u793E\u54E1\u756A\u53F7", "\u30E1\u30E2"];
	...
	getFileName(H_sess: {} | any[]) {
		var filename = "\u904B\u9001ID\u60C5\u5831_" + date("YmdHis") + "." + this.H_View.H_dlprop.extension;
	...
	outputDataLine(A_auth: {} | any[], A_data: {} | any[], H_prop: {} | any[], H_sess: {} | any[], O_model) {
		for (var cnt = 0; cnt < A_data.length; cnt++) //ユーザ設定項目
		{
			...
			var A_str = [A_data[cnt].postid, A_data[cnt].userpostid, A_data[cnt].postname, A_data[cnt].tranid, A_data[cnt].trancoid, A_data[cnt].tranconame, A_data[cnt].username, employeecode, A_data[cnt].memo];
			...
			if (TransitDownloadView.DEBUG != "on") {
