...
//@return void
//
class AddBillMasterDelView extends ViewSmarty {
	...
	constructor() {
		...
		this.H_Dir = this.O_Sess.getPub(AddBillMasterDelView.PUB);
	...
	{
		var H_sess = {
			[AddBillMasterDelView.PUB]: this.O_Sess.getPub(AddBillMasterDelView.PUB),
	...
	//セッションに記録する
	{
		...
		this.O_Sess.SetPub(AddBillMasterDelView.PUB, this.H_Dir);
	...
	//完了画面表示
	{
		...
		O_finish.displayFinish("\u53D7\u6CE8\u5185\u5BB9\u5165\u529B\u30DE\u30B9\u30BF\u3092\u524A\u9664", "/Management/AddBill/menu.php", "\u53D7\u6CE8\u5185\u5BB9\u5165\u529B\u30DE\u30B9\u30BF\u4E00\u89A7\u753B\u9762\u3078");
	}
