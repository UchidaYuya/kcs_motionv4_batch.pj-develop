...
//@return void
//
class CopyModView extends ManagementModViewBase {
	constructor() {
		super();
	}
	...
	//現在の変更のとき
	{
		...
		if (date("Ym") == H_sess[CopyModView.PUB].cym) {
			A_tmp = {
				name: "pastflg",
	...
	{
		if (H_sess.post.copyid == H_sess.get.manageno && H_sess.post.copycoid == H_sess.get.coid) {
			H_sess.post.pre_copyid = "";
			H_sess.post.pre_copycoid = "";
			return false;
		} else {
			H_sess.post.pre_copyid = H_sess.get.manageno;
			H_sess.post.pre_copycoid = H_sess.get.coid;
			return true;
		}
	}
	...
	viewChgKeyError() //エラー画面表示
	{
		...
		O_err.display("\u8ACB\u6C42\u304C\u3042\u308B\u30B3\u30D4\u30FC\u6A5F\u306E\u30B3\u30D4\u30FC\u6A5FID\u3001\u30E1\u30FC\u30AB\u30FC\u306F\u5909\u66F4\u3067\u304D\u307E\u305B\u3093\u3002", 0, _SERVER.PHP_SELF, "\u623B\u308B");
	}
	...
	//完了画面表示
	{
		...
		O_finish.displayFinish("\u30B3\u30D4\u30FC\u6A5F\u5909\u66F4", "./menu.php", "\u4E00\u89A7\u753B\u9762\u3078");
	}
