...
//@return void
//
class HealthcareDelView extends ManagementDelViewBase {
	constructor() {
		super();
	}
	...
	viewCanNotError() //エラー画面表示
	{
		...
		O_err.display("\u8ACB\u6C42\u304C\u3042\u308B\u30D8\u30EB\u30B9\u30B1\u30A2ID\u306E\u524A\u9664\u306F\u3067\u304D\u307E\u305B\u3093\u3002", 0, "./menu.php", "\u623B\u308B");
	}
	...
	//完了画面表示
	{
		...
		O_finish.displayFinish("\u30D8\u30EB\u30B9\u30B1\u30A2ID\u524A\u9664", "/Management/Healthcare/menu.php", "\u4E00\u89A7\u753B\u9762\u3078");
	}
