...
//@return void
//
class ManagementDelView extends ManagementDelViewBase {
	constructor() {
		super();
	}
	...
	viewCanNotError() //エラー画面表示
	{
		...
		if (this.O_Sess.language == "ENG") {
			O_err.display("Billed admin information can not be deleted", 0, "./menu.php", "Back");
		} else {
			O_err.display("\u8ACB\u6C42\u304C\u3042\u308B\u7BA1\u7406\u60C5\u5831\u306E\u524A\u9664\u306F\u3067\u304D\u307E\u305B\u3093\u3002", 0, "./menu.php", "\u623B\u308B");
		}
	}
	...
	//表示言語分岐
	{
		...
		if (this.O_Sess.language == "ENG") {
			O_finish.displayFinish("Delete of Admin informations", "./menu.php", "To list screen", "", "ENG");
		} else {
			O_finish.displayFinish("\u7BA1\u7406\u60C5\u5831\u524A\u9664", "./menu.php", "\u4E00\u89A7\u753B\u9762\u3078");
		}
	}
