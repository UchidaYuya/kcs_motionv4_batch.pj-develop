...
//@return void
//
class EtcAddView extends ManagementAddViewBase {
	constructor() {
		super();
	}
	...
	//完了画面表示
	{
		...
		O_finish.displayFinish("ETC\u30AB\u30FC\u30C9\u65B0\u898F\u767B\u9332", "/Management/ETC/menu.php", "\u4E00\u89A7\u753B\u9762\u3078");
	}
