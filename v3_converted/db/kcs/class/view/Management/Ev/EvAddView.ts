...
//@return void
//
class EvAddView extends ManagementAddViewBase {
	constructor() {
		super();
	}
	...
	//クイックフォームオブジェクト生成
	{
		var A_formelement = this.getEvAddFormElement(O_manage, O_model, H_sess);
		var A_tmp = {
			name: "addsubmit",
			label: this.NextName,
			inputtype: "submit"
	...
	//ここで使用する自作関数の読込
	{
		var A_rule = this.getEvAddFormRule();
	...
	//完了画面表示
	{
		...
		O_finish.displayFinish("EV ID\u65B0\u898F\u767B\u9332", "/Management/Ev/menu.php", "\u4E00\u89A7\u753B\u9762\u3078");
	}
