...
//@uses SuoImportKccsView
//@uses SuoImportKccsModel
//
//
...
require("view/script/SuoImportKccsView.php");

require("model/script/SuoImportKccsModel.php");
...
//@return void
//
class SuoImportKccsProc extends ProcessBaseBatch {
