...
require("model/Management/Terminal/ManagementTerminalMenuModel.php");
...
//@return void
//
class ManagementTerminalMenuProc extends ManagementMenuProcBase {
	...
	get_Model(H_g_sess: {} | any[], O_manage) {
		return new ManagementTerminalMenuModel(this.get_DB(), H_g_sess, O_manage);
	}
