...
require("model/Management/Purchase/Download/PurchaseFullDownloadModel.php");
...
//@return void
//
class PurchaseFullDownloadProc extends ManagementDownloadProcBase {
	...
	get_Model(H_g_sess: {} | any[], O_manage) {
		return new PurchaseFullDownloadModel(this.get_DB(), H_g_sess, O_manage);
	}
