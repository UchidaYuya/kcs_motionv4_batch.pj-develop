...
require("view/Management/AddBill/AddBillMasterDelView.php");

require("model/Management/AddBill/AddBillMasterDelModel.php");
...
//@return void
//
class AddBillMasterDelProc extends ProcessBaseHtml {
	...
	get_View() {
		return new AddBillMasterDelView();
	}

	get_Model(H_g_sess) {
		return new AddBillMasterDelModel(this.get_DB(), H_g_sess);
	}
