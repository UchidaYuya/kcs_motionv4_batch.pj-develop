...
//2010/10/01 石崎 作成
//
//@uses BDSettingsAuAddNumberView
//@package BDSettings
//@subpackage Process
...
//@return void
//
class BDSettingsAuAddNumberProc extends BDSettingsDocomoAddNumberProc {
	constructor(H_param: {} | any[] = Array()) {
		super(H_param);
	}

	getView() {
		if (!(undefined !== this.O_view) || !(this.O_view instanceof BDSettingsAuAddNumberView)) {
			this.O_view = new BDSettingsAuAddNumberView();
		}
