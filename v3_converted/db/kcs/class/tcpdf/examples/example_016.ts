...
//END OF FILE
//============================================================+
var permissions, user_pass, owner_pass, mode, pubkeys;
...
pdf.SetProtection(permissions = ["print", "copy"], user_pass = "", owner_pass = undefined, mode = 0, pubkeys = undefined);
