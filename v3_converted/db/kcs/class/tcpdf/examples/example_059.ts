...
class TOC_TCPDF extends TCPDF {
	Header() {
		if (this.tocpage) // replace the following parent::Header() with your code for TOC page
			{
				super.Header();
			} else // replace the following parent::Header() with your code for normal pages
			{
				super.Header();
			}
	}
	...
	Footer() {
		if (this.tocpage) // replace the following parent::Footer() with your code for TOC page
			{
				super.Footer();
			} else // replace the following parent::Footer() with your code for normal pages
			{
				super.Footer();
			}
	}
...
var pdf = new TOC_TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, "UTF-8", false);
