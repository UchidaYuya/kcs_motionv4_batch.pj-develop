...
//@return void
//
class EtcMoveModel extends ManagementEtcModel {
	...
	checkPreTrgManageAuth(A_data: {} | any[], A_prepostid: {} | any[]) {
		...
		{
			var res = this.checkPreEtcAuth(A_data[cnt].cardno, A_prepostid);

			if (res < 1) {
				var O_err = new ViewError();
				O_err.display("\u524D\u6708\u306B\u5B58\u5728\u3057\u306A\u3044ETC\u30AB\u30FC\u30C9\u304C\u542B\u307E\u308C\u3066\u3044\u307E\u3059\u3002<BR>\u524D\u6708\u5206\u3082\u79FB\u52D5\u306E\u30C1\u30A7\u30C3\u30AF\u3092\u5916\u3057\u3066\u304F\u3060\u3055\u3044", 0, _SERVER.PHP_SELF, "\u623B\u308B");
				throw die();
			}
		}
