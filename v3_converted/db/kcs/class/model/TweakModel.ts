...
//@return void
//
class TweakModel extends ModelBase {
	...
	tweakDetailsTelno(pactid, yyyymm, carid) {
		...
		var A_corp_cd = this.getTweakableCorpCd(pactid, carid);
		var sql = "SELECT telno FROM " + tel_details_tb + " WHERE pactid = " + pactid + " AND carid = " + carid + " AND telno IN(" + "SELECT " + tel_tb + ".telno " + "FROM " + tel_tb + " " + "INNER JOIN " + post_tb + " ON " + tel_tb + ".postid = " + post_tb + ".postid " + "WHERE " + post_tb + ".pactid = " + pactid + " AND " + post_tb + ".postid IN(" + "SELECT " + post_relation_tb + ".postidchild " + "FROM " + post_relation_tb + " WHERE " + "level >= " + this.getSetting().suo_cd_post_level + " AND pactid = " + pactid + ") AND " + post_tb + ".pint1 IS NOT NULL AND " + post_tb + ".pint1 IN (" + A_corp_cd.join(", ") + ")) GROUP BY telno ORDER BY telno";
		return this.get_DB().queryHash(sql);
	}

	getTweakableCorpCd(pactid, carid) {
		var sql = "SELECT corp_cd FROM tweak_config_tb WHERE pactid = " + pactid;

		if (carid == this.getSetting().car_docomo) {
			sql += " AND  docomo_tweak_flag = true";
		} else if (carid == this.getSetting().car_au) {
	...
	insertThisPoint(pactid, yyyymm, H_data) {
		...
		//array_push($A_insertdata, array($postid, $H_thispoint["docomo"], $H_thispoint["au"]));
		{
			...
			var H_userpost = O_post.getPostData(postid, MtTableUtil.getTableNo(yyyymmtrue));
	...
	checkNullCocdPost(pactid, yyyymm) {
		...
		var post_tb = MtTableUtil.makeTableName("post_tb", MtTableUtil.getTableNo(yyyymm));
		var post_relation_tb = MtTableUtil.makeTableName("post_relation_tb", MtTableUtil.getTableNo(yyyymm));
		var sql = "SELECT * FROM " + tel_details_tb + " WHERE " + " pactid = " + pactid + " AND carid IN(" + this.getSetting().car_docomo + "," + this.getSetting().car_au + ")" + " AND telno IN(" + "SELECT " + tel_tb + ".telno " + "FROM " + tel_tb + " " + "INNER JOIN " + post_tb + " ON " + tel_tb + ".postid = " + post_tb + ".postid " + "WHERE " + post_tb + ".pactid = " + pactid + " AND " + post_tb + ".postid IN(" + "SELECT " + post_relation_tb + ".postidchild " + "FROM " + post_relation_tb + " WHERE " + "level >= " + this.getSetting().suo_cd_post_level + " AND pactid = " + pactid + ") AND " + post_tb + ".pint1 IS NULL) ORDER BY telno,detailno";
		return this.get_DB().queryHash(sql);
	}
	...
	tweakTaxAU(pactid, yyyymm, A_tellist) {
		...
		var post_tb = MtTableUtil.makeTableName("post_tb", MtTableUtil.getTableNo(yyyymm));
		var post_relation_tb = MtTableUtil.makeTableName("post_relation_tb", MtTableUtil.getTableNo(yyyymm));
		var sql = "SELECT telno,code,charge,detailno,recdate FROM " + tel_details_tb + " WHERE " + " pactid = " + pactid + " AND carid = " + this.getSetting().car_au + " AND code = '" + this.getSetting().suo_au_taxcode + "' " + " AND telno IN(" + "SELECT " + tel_tb + ".telno " + "FROM " + tel_tb + " " + "INNER JOIN " + post_tb + " ON " + tel_tb + ".postid = " + post_tb + ".postid " + "WHERE " + post_tb + ".pactid = " + pactid + " AND " + tel_tb + ".telno IN('" + A_tellist.join("','") + "') AND " + post_tb + ".postid IN(" + "SELECT " + post_relation_tb + ".postidchild " + "FROM " + post_relation_tb + " WHERE " + "level >= " + this.getSetting().suo_cd_post_level + " AND pactid = " + pactid + ") AND " + post_tb + ".pint1 IS NOT NULL) ORDER BY telno,detailno";
		return this.get_DB().queryHash(sql);
	}

	tweakTaxDocomo(pactid, yyyymm, telnos = undefined) {
		var tel_details_tb = MtTableUtil.makeTableName("tel_details_tb", MtTableUtil.getTableNo(yyyymm));
		var tel_tb = MtTableUtil.makeTableName("tel_tb", MtTableUtil.getTableNo(yyyymm));
		var post_tb = MtTableUtil.makeTableName("post_tb", MtTableUtil.getTableNo(yyyymm));
		var post_relation_tb = MtTableUtil.makeTableName("post_relation_tb", MtTableUtil.getTableNo(yyyymm));
		var sql = "SELECT telno,code,charge,detailno,recdate FROM " + tel_details_tb + " WHERE " + " pactid = " + pactid + " AND carid = " + this.getSetting().car_docomo + " AND code = '" + this.getSetting().suo_docomo_taxcode + "' " + " AND telno IN(";

		if (is_null(telnos)) {
			var A_corp_cd = this.getTweakableCorpCd(pactid, this.getSetting().car_docomo);
			sql += "SELECT " + tel_tb + ".telno " + "FROM " + tel_tb + " " + "INNER JOIN " + post_tb + " ON " + tel_tb + ".postid = " + post_tb + ".postid " + "WHERE " + post_tb + ".pactid = " + pactid + " AND " + post_tb + ".postid IN(" + "SELECT " + post_relation_tb + ".postidchild " + "FROM " + post_relation_tb + " WHERE " + "level >= " + this.getSetting().suo_cd_post_level + " AND pactid = " + pactid + ") AND " + post_tb + ".pint1 IS NOT NULL AND " + post_tb + ".pint1 IN (" + A_corp_cd.join(", ") + ")";
		} else {
			sql += "'" + telnos.join("', '") + "'";
		}
	...
	tweakNewTaxAU(pactid, yyyymm, A_tellist) {
		...
		var post_tb = MtTableUtil.makeTableName("post_tb", MtTableUtil.getTableNo(yyyymm));
		var post_relation_tb = MtTableUtil.makeTableName("post_relation_tb", MtTableUtil.getTableNo(yyyymm));
		var sql = "SELECT telno, CAST(FLOOR(SUM(charge)*" + this.getSetting().excise_tax + ") AS INTEGER) AS tax FROM " + tel_details_tb + " WHERE " + " pactid = " + pactid + " AND carid = " + this.getSetting().car_au + " AND taxkubun = '" + this.getSetting().suo_au_taxkubun + "' " + " AND telno IN(" + "SELECT " + tel_tb + ".telno " + "FROM " + tel_tb + " " + "INNER JOIN " + post_tb + " ON " + tel_tb + ".postid = " + post_tb + ".postid " + "WHERE " + post_tb + ".pactid = " + pactid + " AND " + tel_tb + ".telno IN('" + A_tellist.join("','") + "') AND " + post_tb + ".postid IN(" + "SELECT " + post_relation_tb + ".postidchild " + "FROM " + post_relation_tb + " WHERE " + "level >= " + this.getSetting().suo_cd_post_level + " AND pactid = " + pactid + ") AND " + post_tb + ".pint1 IS NOT NULL) GROUP BY telno ORDER BY telno";
		var A_tmp = this.get_DB().queryHash(sql);
		var H_tmp = Array();
	...
	tweakNewTotalAU(pactid, yyyymm, A_tellist) {
		...
		var post_tb = MtTableUtil.makeTableName("post_tb", MtTableUtil.getTableNo(yyyymm));
		var post_relation_tb = MtTableUtil.makeTableName("post_relation_tb", MtTableUtil.getTableNo(yyyymm));
		var sql = "SELECT telno, SUM(charge) AS charge FROM " + tel_details_tb + " INNER JOIN utiwake_tb ON " + tel_details_tb + ".code = utiwake_tb.code AND " + tel_details_tb + ".carid = utiwake_tb.carid " + " WHERE " + " " + tel_details_tb + ".pactid = " + pactid + " AND " + tel_details_tb + ".carid = " + this.getSetting().car_au + " AND utiwake_tb.codetype = " + this.get_DB().dbQuote(this.getSetting().suo_au_calc_total_codetype, "text", true) + " AND " + tel_details_tb + ".telno IN(" + "SELECT " + tel_tb + ".telno " + "FROM " + tel_tb + " " + " INNER JOIN " + post_tb + " ON " + tel_tb + ".postid = " + post_tb + ".postid " + "WHERE " + post_tb + ".pactid = " + pactid + " AND " + tel_tb + ".telno IN('" + A_tellist.join("','") + "') AND " + post_tb + ".postid IN(" + "SELECT " + post_relation_tb + ".postidchild " + "FROM " + post_relation_tb + " WHERE " + "level >= " + this.getSetting().suo_cd_post_level + " AND pactid = " + pactid + ") AND " + post_tb + ".pint1 IS NOT NULL) GROUP BY " + tel_details_tb + ".telno ORDER BY " + tel_details_tb + ".telno";
		var A_tmp = this.get_DB().queryHash(sql);
		var H_tmp = Array();
	...
	tweakTotalAU(pactid, yyyymm, A_tellist) {
		...
		var post_tb = MtTableUtil.makeTableName("post_tb", MtTableUtil.getTableNo(yyyymm));
		var post_relation_tb = MtTableUtil.makeTableName("post_relation_tb", MtTableUtil.getTableNo(yyyymm));
		var sql = "SELECT telno, code, charge, detailno,recdate FROM " + tel_details_tb + " WHERE " + " pactid = " + pactid + " AND carid = " + this.getSetting().car_au + " AND code = '" + this.getSetting().suo_au_totalcode + "' " + " AND telno IN(" + "SELECT " + tel_tb + ".telno " + "FROM " + tel_tb + " " + "INNER JOIN " + post_tb + " ON " + tel_tb + ".postid = " + post_tb + ".postid " + "WHERE " + post_tb + ".pactid = " + pactid + " AND " + tel_tb + ".telno IN('" + A_tellist.join("','") + "') AND " + post_tb + ".postid IN(" + "SELECT " + post_relation_tb + ".postidchild " + "FROM " + post_relation_tb + " WHERE " + "level >= " + this.getSetting().suo_cd_post_level + " AND pactid = " + pactid + ") AND " + post_tb + ".pint1 IS NOT NULL) ORDER BY telno";
		return this.get_DB().queryHash(sql);
	}

	tweakNewTaxDocomo(pactid, yyyymm, telnos = undefined) {
		var tel_details_tb = MtTableUtil.makeTableName("tel_details_tb", MtTableUtil.getTableNo(yyyymm));
		var tel_tb = MtTableUtil.makeTableName("tel_tb", MtTableUtil.getTableNo(yyyymm));
		var post_tb = MtTableUtil.makeTableName("post_tb", MtTableUtil.getTableNo(yyyymm));
		var post_relation_tb = MtTableUtil.makeTableName("post_relation_tb", MtTableUtil.getTableNo(yyyymm));
		var sql = "SELECT telno, CAST(FLOOR(SUM(charge)*" + this.getSetting().excise_tax + ") AS INTEGER) AS tax FROM " + tel_details_tb + " WHERE " + " pactid = " + pactid + " AND carid = " + this.getSetting().car_docomo + " AND taxkubun = '" + this.getSetting().suo_docomo_taxkubun + "' " + " AND telno IN(";
	...
	tweakNewTaxOnesDocomo(pactid, yyyymm) {
		...
		var post_tb = MtTableUtil.makeTableName("post_tb", MtTableUtil.getTableNo(yyyymm));
		var post_relation_tb = MtTableUtil.makeTableName("post_relation_tb", MtTableUtil.getTableNo(yyyymm));
		var sql = "SELECT telno, CAST(FLOOR(SUM(charge)*" + this.getSetting().excise_tax + ") AS INTEGER) AS tax FROM " + tel_details_tb + " WHERE " + " pactid = " + pactid + " AND carid = " + this.getSetting().car_docomo + " AND code NOT IN('" + this.getSetting().A_suo_docomo_taxkubun_notones.join("','") + "')" + " AND taxkubun = '" + this.getSetting().suo_docomo_taxkubun_ones + "' " + " AND telno IN(" + "SELECT " + tel_tb + ".telno " + "FROM " + tel_tb + " " + "INNER JOIN " + post_tb + " ON " + tel_tb + ".postid = " + post_tb + ".postid " + "WHERE " + post_tb + ".pactid = " + pactid + " AND " + post_tb + ".postid IN(" + "SELECT " + post_relation_tb + ".postidchild " + "FROM " + post_relation_tb + " WHERE " + "level >= " + this.getSetting().suo_cd_post_level + " AND pactid = " + pactid + ") AND " + post_tb + ".pint1 IS NOT NULL) GROUP BY telno ORDER BY telno";
		var A_tmp = this.get_DB().queryHash(sql);
		var H_tmp = Array();
