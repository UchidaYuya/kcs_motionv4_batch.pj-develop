...
//@return void
//
class BillHealthcareFullDownloadModel extends BillHealthcareMenuModel {
	...
	//データ取得
	{
		var postid = H_sess[BillHealthcareFullDownloadModel.PUB].current_postid;
		this.setTableName(H_sess[BillHealthcareFullDownloadModel.PUB].cym);
	...
	{
		var A_where = Array();
		A_where.push("ppb.healthcoid=" + H_post.healthcoid);
