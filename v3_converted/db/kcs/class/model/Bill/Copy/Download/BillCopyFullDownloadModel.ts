...
//@return void
//
class BillCopyFullDownloadModel extends BillCopyMenuModel {
	...
	//データ取得
	{
		var postid = H_sess[BillCopyFullDownloadModel.PUB].current_postid;
		this.setTableName(H_sess[BillCopyFullDownloadModel.PUB].cym);
	...
	{
		var A_where = Array();
		A_where.push("ppb.copycoid=" + H_post.copycoid);
