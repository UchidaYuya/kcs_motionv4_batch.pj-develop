...
const SCRIPT_NAMEJ = "\u30A8\u30CB\u30FC\u30E6\u30FC\u30B6\u30FC\u30A4\u30F3\u30DD\u30FC\u30C8\u30E1\u30A4\u30F3";
...
const LOG_DELIM = " ";
const PHP = "php";
const IMPORT_ANYFU_BILL = BAT_DIR + "/import_anyfu_bill.php";
const IMPORT_ANYFU_TUWA = BAT_DIR + "/import_anyfu_tuwa.php";
const IMPORT_ANYUSER_BILL = BAT_DIR + "/import_anyuser_bill.php";
const GEN_ANYUSER = BAT_DIR + "/gen_anyuser.php";
...
var cmd = escapeshellcmd(PHP + " " + IMPORT_ANYFU_BILL + co_arg);
system(cmd, status);
