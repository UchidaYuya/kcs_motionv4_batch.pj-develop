...
const SCRIPT_NAMEJ = "SoftBank\u30A4\u30F3\u30DD\u30FC\u30C8\u30E1\u30A4\u30F3";
...
var cmd = escapeshellcmd(PHP + " " + IMPORT_SOFTBANK_BILL + co_arg);
system(cmd, status);
...
cmd = escapeshellcmd(PHP + " " + IMPORT_VODA_TUWA + co_arg2);
system(cmd, status);
