	...
	for (idx = 0;; idx < A_dataDir.length; idx++) //全社指定
	{
		...
		if (is_dir(dataDirPact) == true) {
			if (is_file(dataDirPact + "/OTMEISAI.txt") == false) {
				if (DEBUG_FLG) logging("WARNING: \u5BFE\u8C61\u30D5\u30A1\u30A4\u30EB\u304C\u307F\u3064\u304B\u308A\u307E\u305B\u3093\uFF08" + dataDirPact + "/OTMEISAI.txt\uFF09");
			...
			} else //最初にOTMEISAIを配列に入れる
				{
					...
					if (DEBUG_FLG) logging("INFO: \u5BFE\u8C61\u8ACB\u6C42\u30C7\u30FC\u30BF\u30D5\u30A1\u30A4\u30EB\u540D " + dataDirPact + "/OTMEISAI.txt");
				}
		}
	}
...
//ダミー
{
	...
	if (mb_strlen(A_line[8], "UTF-8") != 10) {
		if (DEBUG_FLG) logging("\u51FA\u53E3ID\u540D\u306E\u30D5\u30A9\u30FC\u30DE\u30C3\u30C8\u304C\u9055\u3044\u307E\u3059 " + A_line[8]);
		errcnt++;
	}
