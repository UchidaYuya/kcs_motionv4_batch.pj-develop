...
//auのPacketRatio更新のため、一時的に作成したバッチ
//
//作成：中西	2006/11/16
//更新：中西	2008/10/02	Softbank対応
//更新：中西	2010/09/13	auのデータ事前準備用に修正
//===========================================================================
//require_once("lib/update_trend_nttdocomo.php");
//require_once("lib/update_trend_voda.php");
//プロセス解説文字列
//実行可能時間
//---------------------------------------------------------------------------
//機能：通話明細統計情報抽出プロセス(ドコモ、au、Softbank対応)
...
require("lib/update_trend_au_pratio201009.php");
