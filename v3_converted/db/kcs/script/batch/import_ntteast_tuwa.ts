...
//レコード種別ＩＤ 通話=3
//---------------------------------------------------------------------------
//機能：クランプファイルインポートプロセス(ＮＴＴ東日本-Custom)
...
const G_PROCNAME_J_IMPORT = "\u901A\u8A71\u8A73\u7D30\u30A4\u30F3\u30DD\u30FC\u30C8\u30D7\u30ED\u30BB\u30B9[NTT\u6771\u65E5\u672C]";
const G_PROCNAME_IMPORT = "import_ntt_east";
const G_PROCNAME = "import_ntt_east";
const G_COMPANY_ID = "NTT_east/tuwa";
const G_CARRIER_ID = "7";
const G_RECODE_ID = "3";
...
//ＮＴＴ東日本custom
//一行(固定長)を分割して処理する
class import_ntt_east extends import_ntt_tuwa_base {
			...
			//for DEBUG
			{
				...
				if (this.m_first_flag) {
					...
					if (this.m_db.getOne(sql) > 1) {
						...
						GLOBALS.G_COMMON_LOG.putError(G_SCRIPT_WARNING, this.m_procname_j + " " + this.m_target_pactid + " " + this.m_compname + " " + yyyymm + " " + this.m_targetFile + "\u8B66\u544A\uFF1A \u8AB2\u91D1\u5148\u96FB\u8A71\u756A\u53F7(" + bill_telno + ")\u304C\u8907\u6570\u5B58\u5728\u3057\u307E\u3059\u3002", 4);
						return false;
					}
				}
